...
namespace WalkingTec.Mvvm.Core.Test
{
    ...
    [SoftKey(nameof(StudentNoFK.LoginName))]
    public class StudentNoFK : PersistPoco
    {
        [Display(Name = "账号")]
        ...
        [Display(Name = "专业")]
        [NotMapped]
        [SoftFK(nameof(StudentMajorNoFK.StudentId))]
        public List<StudentMajorNoFK> StudentMajor { get; set; }
    }
}
