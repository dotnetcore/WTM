...
namespace WalkingTec.Mvvm.Demo.Controllers
{
    ...
    public class EmployeeController : BaseController
    {
        ...
        {
            var vm = CreateVM<EmployeeListVM>();
        ...
        {
            var vm = CreateVM<EmployeeBatchVM>(Ids: IDs);
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("批量修改")]
        public ActionResult DoBatchEdit(EmployeeBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("批量删除")]
        public ActionResult DoBatchDelete(EmployeeBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = CreateVM<EmployeeImportVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("导入")]
        public ActionResult Import(EmployeeImportVM vm, IFormCollection nouse)
        {
