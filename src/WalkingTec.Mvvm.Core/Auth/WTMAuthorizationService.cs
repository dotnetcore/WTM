...
namespace WalkingTec.Mvvm.Core.Auth
{
    ...
    /// </summary>
    public class WTMAuthorizationService : IAuthorizationService
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="WTMAuthorizationService"/>.
        /// </summary>
        ...
        public WTMAuthorizationService(IAuthorizationPolicyProvider policyProvider, IAuthorizationHandlerProvider handlers, ILogger<WTMAuthorizationService> logger, IAuthorizationHandlerContextFactory contextFactory, IAuthorizationEvaluator evaluator, IOptions<AuthorizationOptions> options)
        {
            if (options == null)
            {
