    ...
    <a-row :gutter="8" type="flex">
      <a-col :span="12">
        <a-card title="WalkingTec.Mvvm框架" style="height:100%">
          ...
          <p>
            2017年9月，我们将代码移植到了.Net
            Core上，并进行了深度优化和重构，推出了基于Asp.net Core和EF
            Core的全新框架，新框架在架构，稳定性，速度上都有长足进步，真正成为一款高效开发的利器。
          </p>
        </a-card>
      </a-col>
      <a-col :span="12">
      ...
      <a-col :span="12" style="margin-top:6px">
        <a-card title="即刻体验WTM之美" style="height:100%">
          <p>
            现在就点
            <a href="https://wtmdoc.walkingtec.cn/setup" target="_black"
              >这里</a
            >
            立刻生成第一个WTM项目吧
          </p>
          <p>
            <a href="https://community.walkingtec.cn/" target="_black"
              >有问题？来WTM社区提问吧！</a
            >
          </p>
        </a-card>
