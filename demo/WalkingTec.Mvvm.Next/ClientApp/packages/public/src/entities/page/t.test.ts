...
it('Page：', async () => {
    ...
    var test = `attachment; filename=Export_FrameworkGroup_2019-12-16.xls; filename*=UTF-8''Export_FrameworkGroup_2019-12-16.xls`;
    const a = /.*filename=([a-z\d\.\-_]+);\sfilename.*/i.test(test)
    console.log("TCL: a", RegExp.$1)
});
