...
namespace WalkingTec.Mvvm.Demo.Controllers
{
    ...
    [ApiController]
    [Route("api/Student")]
	public partial class StudentApiController : BaseApiController
    {
        ...
        [HttpGet("{id}")]
        public StudentApiVM Get(string id)
        {
            var vm = Wtm.CreateVM<StudentApiVM>(id);
            return vm;
        }
        ...
        {
            var vm = Wtm.CreateVM<StudentApiImportVM>();
