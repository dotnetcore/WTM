...
namespace WalkingTec.Mvvm.Demo.Controllers
{
    ...
    public partial class TreeTestController : BaseController
    {
        ...
        [HttpPost]
        [ActionDescription("Sys.Create")]
        public ActionResult Create(TreeTestVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        public ActionResult Edit(TreeTestVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchEdit")]
        public ActionResult DoBatchEdit(TreeTestBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchDelete")]
        public ActionResult DoBatchDelete(TreeTestBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("Sys.Import")]
        public ActionResult Import(TreeTestImportVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        public IActionResult ExportExcel(TreeTestListVM vm)
        {
