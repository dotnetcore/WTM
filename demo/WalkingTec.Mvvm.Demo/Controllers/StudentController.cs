...
namespace WalkingTec.Mvvm.Demo.Controllers
{
    ...
    public partial class StudentController : BaseController
    {
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchEdit")]
        public async Task<IActionResult> DoBatchEdit(StudentBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchDelete")]
        public async Task<IActionResult> DoBatchDelete(StudentBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("Sys.Import")]
        public async Task<IActionResult> Import(StudentImportVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> ExportExcel(StudentListVM vm)
        {
