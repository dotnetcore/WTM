...
namespace WalkingTec.Mvvm.Demo.Controllers
{
    ...
    public partial class SoftFacInfoController : BaseController
    {
        ...
        [HttpPost]
        [ActionDescription("Sys.Create")]
        public ActionResult Create(SoftFacInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        public ActionResult Edit(SoftFacInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchEdit")]
        public ActionResult DoBatchEdit(SoftFacInfoBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchDelete")]
        public ActionResult DoBatchDelete(SoftFacInfoBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("Sys.Import")]
        public ActionResult Import(SoftFacInfoImportVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        public IActionResult ExportExcel(SoftFacInfoListVM vm)
        {
