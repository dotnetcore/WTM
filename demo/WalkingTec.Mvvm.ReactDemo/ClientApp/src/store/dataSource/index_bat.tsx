  ...
  */
  ...
  async onSearch(params?: IonSearchParams) {
    try {
      ...
      const res = await this.Request.ajax({ ...this.Urls.search, body: params }).pipe(
        map(data => {
          if (data.Data) {
  ...
  async onDetails(params) {
    ...
    const res = await this.Request.ajax({ ...this.Urls.details, body: params }).toPromise();
    // 设置详情
  ...
  async onInsert(params) {
    ...
    const res = await this.Request.ajax({ ...this.Urls.insert, body: params }).toPromise()
  ...
  async onUpdate(params) {
    ...
    if (isUpdate) {
      ...
      const res = await this.Request.ajax({ ...this.Urls.update, body: params }).toPromise();
  ...
  async onDelete(ids: string[]) {
    try {
      ...
      const res = await this.Request.ajax({ ...this.Urls.delete, body: ids }).toPromise()
  ...
  async onImport(UploadFileId) {
    ...
    try {
      const res = await this.Request.ajax({ ...this.Urls.import, body: UploadFileId }).toPromise();
