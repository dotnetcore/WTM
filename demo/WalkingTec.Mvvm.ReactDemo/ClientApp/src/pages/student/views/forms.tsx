...
export class InsertForm extends React.Component<any, any> {
    ...
    render() {
        ...
        return <InfoShellLayout>
                <FormItem {...props} fieId="Entity.ID" />
                ...
                <FormItem {...props} fieId="Entity.FileId" />
                <FormItem {...props} fieId="Entity.IsValid" />
                <FormItem {...props} fieId="Entity.EnRollDate" />
                <Col span={24}>
                    <FormItem {...props} fieId="Entity.StudentMajor" layout="row" />
                </Col>
