...
export class InsertForm extends React.Component<any, any> {
    ...
    render() {
        ...
        return <InfoShellLayout>
                <FormItem {...props} fieId="Entity.MajorCode" />
                <FormItem {...props} fieId="Entity.MajorName" />
                <FormItem {...props} fieId="Entity.MajorType" />
                <FormItem {...props} fieId="Entity.Remark" />
                <FormItem {...props} fieId="Entity.SchoolId" />
                <Col span={24}>
                    <FormItem {...props} fieId="Entity.StudentMajors" layout="row" />
                </Col>
