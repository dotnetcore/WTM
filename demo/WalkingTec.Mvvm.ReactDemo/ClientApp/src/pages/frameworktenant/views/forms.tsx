...
export class InsertForm extends React.Component<any, any> {
    ...
    render() {
        ...
        return <InfoShellLayout>
                <FormItem {...props} fieId="Entity.TCode" />
                <FormItem {...props} fieId="Entity.TName" />
                <FormItem {...props} fieId="Entity.TDb" />
                <FormItem {...props} fieId="Entity.TDbType" />
                <FormItem {...props} fieId="Entity.DbContext" />
                <FormItem {...props} fieId="Entity.TDomain" />
                <FormItem {...props} fieId="Entity.TenantCode" />
                <FormItem {...props} fieId="Entity.EnableSub"  value={false} />
                <FormItem {...props} fieId="Entity.Enabled"  value={false} />
