				...
				<el-row>
					<el-col :xs="24"  :lg="12" class="mb20">
						<el-form-item ref="Entity_DbContext_FormItem" prop="Entity.DbContext"
							...
							<el-input v-model="state.vmModel.Entity.DbContext" clearable></el-input>
						</el-form-item>
					</el-col>
					<el-col :xs="24"  :lg="12" class="mb20">
						<el-form-item ref="Entity_TDomain_FormItem" prop="Entity.TDomain"
							:label="$t('message._admin.tenant.vm.TDomain')">
							<el-input v-model="state.vmModel.Entity.TDomain" clearable></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
...
const onSubmit = () => {
	...
	formRef.value?.validate((valid: boolean, fields: any) => {
		if (valid) {
			frameworktenantApi().edit(state.vmModel).then(() => {
