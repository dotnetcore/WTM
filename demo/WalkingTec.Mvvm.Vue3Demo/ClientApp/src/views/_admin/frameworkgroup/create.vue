				...
				<el-row>
					<el-col :xs="24"  :lg="12"  class="mb20">
						<el-form-item ref="Entity_GroupCode_FormItem" prop="Entity.GroupCode"
							...
							:rules="[{ required: true, message: $t('message._system.common.vm.input',{input:$t('message._admin.group.vm.GroupCode')}), trigger: 'blur' }]">
							<el-input v-model="state.vmModel.Entity.GroupCode" clearable></el-input>
						</el-form-item>
					</el-col>
					<el-col :xs="24"  :lg="12"  class="mb20">
						<el-form-item ref="Entity_GroupName_FormItem" prop="Entity.GroupName"
							:label="$t('message._admin.group.vm.GroupName')"
							:rules="[{ required: true, message: $t('message._system.common.vm.input',{input:$t('message._admin.group.vm.GroupName')}), trigger: 'blur' }]">
				...
				<el-row>
					<el-col :xs="24"  :lg="12"  class="mb20">
						<el-form-item ref="Entity_ParentId_FormItem" prop="Entity.ParentId"
							...
							<el-cascader :options="state.allGroups" :props="{ checkStrictly: true,emitPath:false,label:'Text',value:'Value',children:'Children' }" clearable filterable class="w100"
					...
					<el-col :xs="24"  :lg="12"  class="mb20">
						<el-form-item ref="Entity_Manager_FormItem" prop="Entity.Manager"
							...
							<el-input v-model="state.vmModel.Entity.Manager" clearable></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
...
const onSubmit = () => {
	formRef.value?.validate((valid: boolean, fields: any) => {
		if (valid) {
			frameworkgroupApi().add(state.vmModel).then(() => {
