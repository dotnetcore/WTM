...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        return (React.createElement(Layout, { className: "app-layout-body", ref: function (e) { return _this.body = ReactDOM.findDOMNode(e); } },
            React.createElement(Content, { className: "app-layout-content" },
                React.createElement(Affix, { target: function () { return _this.body; } },
                    React.createElement(HistoryTabs, __assign({}, this.props, { target: this.body }))),
                this.renderRoutes)));
    };
    return App;
}(React.Component));
