...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.renderMenu = function (menus, index) {
        ...
        return menus.Children.map(function (x, i) {
            return React.createElement(Menu.Item, { key: x.Key }, _this.renderLink(x));
        });
    };
    App.prototype.runderSubMenu = function () {
        ...
        return Store.Meun.subMenu.map(function (menu, index) {
            ...
            return React.createElement(Menu.Item, { key: menu.Key }, _this.renderLink(menu));
        });
    };
    App.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "app-layout-sider", style: { width: width, minWidth: width } },
