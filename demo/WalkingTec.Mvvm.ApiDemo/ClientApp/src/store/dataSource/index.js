...
var Store = /** @class */ (function () {
     ...
     * @param detailsType
     */
    Store.prototype.onModalShow = function (details, detailsType) {
        if (details === void 0) { details = {}; }
        if (detailsType === void 0) { detailsType = 'Insert'; }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(detailsType != "Insert")) return [3 /*break*/, 2];
     ...
     * @param Limit 数据条数
     */
    Store.prototype.onSearch = function (search, sort, Page, Limit) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        details = { Entity: __assign({}, this.details, params) };
                        this.onPageState("loadingEdit", true);
                        if (!this.pageState.detailsType) return [3 /*break*/, 2];
     ...
     * @param Id
     */
    Store.prototype.onDelete = function (Id) {
        return __awaiter(this, void 0, void 0, function () {
            var method, src, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        src = this.Urls.delete.src + "/" + Id;
                        return [4 /*yield*/, this.Request[method](src).toPromise()];
                    case 1:
                        res = _a.sent();
                        if (res) {
    ...
    Object.defineProperty(Store.prototype, "importConfig", {
        ...
        get: function () {
            var _this = this;
            var action = this.Request.address + this.Urls.fileUpload.src;
            return {
                name: 'file',
                multiple: true,
                action: action,
     ...
     * @param UpdateFileId
     */
    Store.prototype.onImport = function (UpdateFileId) {
        return __awaiter(this, void 0, void 0, function () {
            var method, src, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = this.Urls.import.method;
                        src = this.Urls.import.src;
                        return [4 /*yield*/, this.Request[method](src, { UpdateFileId: UpdateFileId }, { "Content-Type": "application/x-www-form-urlencoded" }).toPromise()];
                    case 1:
                        res = _a.sent();
                        console.log(res);
                        if (res) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Request.download({
                                ...
                                body: __spread(this.selectedRowKeys)
                            })];
                    case 1:
                        _a.sent();
                        _a.label = 2;
