  ...
  <card>
    ...
    >
      <template #operate="rowData">
        <el-button
          v-visible="actionList.detail"
          v-if="!isMainHost"
          type="text"
          size="small"
          class="view-btn"
          @click="onDetail(rowData.row)"
        >
          {{ $t("table.detail") }}
        </el-button>
        <el-button
          v-visible="actionList.edit"
          v-if="!isMainHost"
          type="text"
          size="small"
          class="view-btn"
          @click="onEdit(rowData.row)"
        >
          {{ $t("table.edit") }}
        </el-button>
        <el-button
          ...
          size="small"
          class="view-btn"
          @click="openPermission(rowData.row)"
        >
          {{ $t("frameworkrole.AssignPermissions") }}
        </el-button>
        <el-button
          v-if="!isMainHost"
          v-visible="actionList.deleted"
          type="text"
          size="small"
          class="view-btn"
          @click="onDelete(rowData.row)"
        >
          {{ $t("table.delete") }}
        </el-button>
      </template>
